export const exercises = [
  {
    ...
    hint: {
      ...
      es: 'Las negras pueden obtener mejor juego con 1...Db1+ 2.Df1 Dxa2 (no 2...Td1? 3.Tc8+) gracias a su peón pasado exterior. Pero con la primera fila de blancas tan débil, busquemos algo más.',
    },
    solution: {
      ...
      es: '1...Db2! (En la partida real, las blancas se rindieron aquí.) 2.Tc8!? (2.Tc2 Db1+ 3.Df1 Dxc2; 2.De1 Dxc3 3.Dxc3 Td1+ 4.De1 Txe1#) 2...Db1+ 3.Df1 Dxf1+ 4.Rxf1 Txc8 0-1',
    },
    moves: {
      'Qb2': {
        rating: 'best',
...

  {
    ...
    solution: {
      ...
      es: 'No — las negras tienen la contrajugada 1...Txc3! Aún así, tras el propio interludio de blancas 2.Txf7+! Rxf7 3.bxc3, las blancas deberían ganar gracias al potencial peón pasado exterior en la columna g.',
    },
    moves: {
      'Rxf6': {
        rating: 'best',
...

  {
    ...
    title: {
      ...
      es: 'Dominar la Columna y Penetrar',
    },
    game: 'Seirawan – Rivas, 1980',
    hint: {
      en: 'Doubling to dominate the c-file leads to penetration on the 7th rank.',
      es: 'Doblar torres para dominar la columna c lleva a la penetración en la 7ª fila.',
    },
    solution: {
      en: '1.Qc2! Qd7 2.Qc7 with overwhelming advantage. White won after 2...Ba8 3.Nc8!! Bf6 4.Qxb8 Bc6 5.Bxa6.',
      es: '1.Dc2! Dd7 2.Dc7 con ventaja aplastante. Las blancas ganaron tras 2...Aa8 3.Cc8!! Af6 4.Dxb8 Ac6 5.Axa6.',
    },
    moves: {
      'Qc2': {
        rating: 'best',
...

  {
    ...
    title: {
      ...
      es: 'Lucha en las Casillas Negras',
    },
    game: 'Klovan – Ruban, 1986',
    hint: {
      en: 'Look for a way to exploit the weak dark squares around the Black king.',
      es: 'Busca la manera de explotar las débiles casillas negras alrededor del rey negro.',
    },
    solution: {
...

  {
    ...
    hint: {
      ...
      es: 'Una clavada que no puede romperse se llama «absoluta». Busca una jugada que cree tal clavada.',
    },
    solution: {
      en: '1.Rxd6! Rxd6 2.e5 1-0 — the pin on the d6-rook is absolute (the king stands behind it) and the pawn advance wins material.',
      es: '1.Txd6! Txd6 2.e5 1-0 — la clavada sobre la torre d6 es absoluta (el rey está detrás) y el avance de peón gana material.',
    },
    moves: {
      'Rxd6': {
        rating: 'best',
...

  {
    ...
    hint: {
      ...
      es: 'Si te atrae 1...Cc4, atacando a la Dama y el Alfil, ¡olvídalo! En la partida las negras jugaron 1...f6, cediendo un peón. ¿Por qué?',
    },
    solution: {
      ...
      es: 'Las blancas tienen una terrible amenaza: 2.Dg7+! Rxg7 3.Cf5++ Rg8 4.Ch6# — un típico mate de alfil+caballo. Esto funciona contra 1...Cc4 y casi cualquier otra jugada. Claramente 1...f6 era el mal menor.',
    },
    moves: {
      'f6': {
        rating: 'ok',
...

  {
    ...
    hint: {
      ...
      es: 'Cuando un peón que llega a la 7ª fila ataca una pieza, el peón tiene dos casillas de promoción — puede tomar la pieza o avanzar directo. Esta opción extra frecuentemente hace al peón imparable.',
    },
    solution: {
      en: '1.Rxb2! (deflecting the queen from protecting the rook) 1...Qxb2 2.Qxc8+! Nxc8 3.d7 1-0 — the pawn promotes no matter what.',
      es: '1.Txb2! (desviando la dama de la protección de la torre) 1...Dxb2 2.Dxc8+! Cxc8 3.d7 1-0 — el peón promoverá pase lo que pase.',
    },
    moves: {
      'Rxb2': {
        rating: 'best',
